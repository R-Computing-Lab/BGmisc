...
test_that("adjacency_method  'indexed', 'loop', and direct produce the same results for common nuclear matrix", {
  ...
  ped_common_direct1 <- ped2com(hazard, component = "common nuclear", adjacency_method = "direct",method_approach = method_approach_1)
  ped_common_direct2 <- ped2com(hazard, component = "common nuclear", adjacency_method = "direct",method_approach = method_approach_2)
  ped_common_direct3 <- ped2com(hazard, component = "common nuclear", adjacency_method = "direct",method_approach = method_approach_3)

  expect_equal(ped_common_indexed, ped_common_loop, tolerance = tolerance)
  expect_equal(ped_common_loop, ped_common_direct1, tolerance = tolerance)
  expect_equal(ped_common_indexed, ped_common_direct1, tolerance = tolerance)
  expect_equal(ped_common_loop, ped_common_direct2, tolerance = tolerance)
  expect_equal(ped_common_indexed, ped_common_direct2, tolerance = tolerance)
  expect_equal(ped_common_loop, ped_common_direct3, tolerance = tolerance)
  expect_equal(ped_common_indexed, ped_common_direct3, tolerance = tolerance)
  expect_equal(ped_common_direct1, ped_common_direct2, tolerance = tolerance)
  expect_equal(ped_common_direct1, ped_common_direct3, tolerance = tolerance)
  expect_equal(ped_common_direct2, ped_common_direct3, tolerance = tolerance)
})
