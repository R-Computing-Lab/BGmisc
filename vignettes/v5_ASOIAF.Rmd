...
jon_dany_row <- df_links %>%
  ...
  mutate(across(c(addRel, mitRel, cnRel), ~ round(.x, 4)))
...
This plot provides an interactive visualization of the ASOIAF pedigree, allowing users to explore relationships and affected status. The focal individual is highlighted, and tooltips provide additional information about each character. 
