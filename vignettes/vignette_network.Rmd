...
This computes the additive genetic relatedness for everyone in the data.  It returns a square, symmetric matrix that has as many rows and columns as there are IDs.  The entry in the ith row and the jth column gives the relatedness between person i and person j.
