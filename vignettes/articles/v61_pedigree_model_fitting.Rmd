...
rds_dir <- file.path("vignettes", "pkgdown-assets")
...
#   fitted_multi <- readRDS("vignettes/pkgdown-assets/fitted_multi.rds")
...
fitted_multi <- readRDS(
  system.file("extdata", "fitted_multi.RDS", package = "BGmisc")
)
```
```{r, eval = has_openmx}
...
```{r single-fam-results, eval = has_openmx}
cat("Additive genetic (Vad):", fitted_multi$ModelOne$Vad$values, "\n")
