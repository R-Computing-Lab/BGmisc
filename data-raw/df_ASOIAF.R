...
df <- ped2fam(ASOIAF, personID = "personID") %>%
  ...
  mutate(
    ...
    url = case_when(
      ...
      personID %in% c(300:301,318:319) ~ NA_character_,
      ...
      personID %in% c(331:332) ~ "https://awoiaf.westeros.org/index.php/House_Penrose",
