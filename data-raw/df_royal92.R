...
#  244, "George Lascelles",
#  246, "Louis IX",
#  247, "Frederick I of Württemberg",
#  251, "Ernest Augustus",
...
#  262, "George",
 ...
 # 272, "Adolphus Frederick V",
  ...
  279, "Francis of Teck",
#  280, "Alexander Cambridge",
#  281, "Margaret Grosvenor",
  284, "Mary Cambridge",
...
#  444, "Philip of Asturias",
  ...
  500, "Patricia Mountbatten",
  501, "Pamela Mountbatten",
  ...
  751, "Philippe I",
  753, "John IV of Portugal",
  755, "Alfonso IV d'Este",
  756, "Laura Martinozzi",
  758, "Ernest Augustus of Brunswick",
  ...
  770, "Ernest Augustus",
  781, "George John Spencer",
  782, "Lavinia Bingham",
  785, "Richard Curzon-Howe",
  788, "James Hamilton",
  789, "George Charles Bingham",
  790, "Anne Brudenell",
  791, "Caroline Paget",
  792, "Charles Lennox",
  ...
  2079, "Margaret Beaufort",
  2080, "Thomas Courtenay",
  2082, "Richard Beauchamp",
  2083, "Henry Beaufort",
  2084, "Edmund Beaufort",
  2096, "Humphrey Stafford",
  2099, "Thomas Boleyn",
  2100, "Joanna of Castile",
  2102, "Frances Devereux",
  2103, "Robert Devereux",
  2104, "Henry Clifford",
  2108, "Edward Seymour",
  ...
  2191, "Dermot O'Brien",
  2192, "Murrough O'Brien",
  2193, "Murrough O'Brien",
  2194, "Dermod O'Brien",
  ...
  2216, "Aoife",
  2217, "William Marshal",
  2218, "Isabel de Clare",
  2219, "Richard de Clare",
  2220, "Aoife",
  2221, "Dermot MacMurrough",
  ...
  2315, "Robert Dudley",
  2317, "Mary Dudley",
  2318, "Catherine Dudley",
  2319, "Anne Seymour",
  2323, "Anne Russell",
  2326, "Thomas Howard",
  2329, "Henry Hastings",
  2332, "Henry Herbert",
  2334, "Margaret Clifford",
  2335, "Henry Stanley",
  2337, "Elizabeth Howard",
  2341, "Thomas Howard",
  2343, "Thomas Howard",
  2345, "Elizabeth Stafford",
  2348, "William Howard",
  2353, "Edward Stanley",
  2354, "Henry Radcliffe",
  2355, "Henry Howard",
  2356, "Mary Howard",
  2357, "Thomas Howard",
  2359, "Thomas Howard",
  ...
  2369, "Thomas Howard",
  2372, "Thomas Howard",
  2374, "Catherine Knyvett",
  2375, "Theophilus Howard",
  2376, "Thomas Howard",
  2383, "William Cavendish",
  2384, "William Cecil",
  2385, "Robert Devereux",
  2386, "Robert Carr",
  2389, "Frances Howard",
  2390, "Frances Howard",
  2391, "Ludovic Stuart",
  ...
  2393, "Anne Stanhope",
  2394, "Henry Carey",
  2397, "Francis Seymour",
  2403, "Catherine Carey",
  2407, "William Knollys",
  2411, "Walter Devereux",
  2414, "Gerald FitzGerald",
  2415, "Charles II",
  2416, "Mariana of Austria",
  ...
  2683, "George Bagration-Mukhranski",
  ...
  2962, "Victoria Lockwood",
  2963, "Kitty Spencer",
  2964, "Olga of Greece and Denmark",
  2965, "Paul of Yugoslavia",
...
royal92_cleaned <- royal92 %>%
  mutate(
    ...
    attribute_title = case_when(
      ...
      personID == 125 ~ "2nd Duchess of Fife",
      personID == 129 ~ "Duke of Saxe-Coburg and Gotha",
      personID == 132 ~ "Duke of Cambridge",
      personID == 137 ~ "Duke of Teck",
      personID == 146 ~ "Countess of Strathmore and Kinghorne",
      personID == 174 ~ "Lady Elphinstone",
      personID == 175 ~ "15th Earl of Strathmore and Kinghorne",
      personID == 179 ~ "Countess Granville",
      personID == 183 ~ "Countess of Strathmore and Kinghorne",
      personID == 187 ~ "9th Earl of Strathmore and Kinghorne",
      personID == 189 ~ "10th Earl of Strathmore and Kinghorne",
      personID == 191 ~ "16th Lord Elphinstone",
      personID == 195 ~ "4th Earl Granville",
      personID == 201 ~ "9th Duke of Argyll",
      personID == 224 ~ "Princess of Battenberg; Princess of Erbach-Schönberg",
      personID == 230 ~ "Princess of Greece and Denmark",
      personID == 240 ~ "Lady McCorquodale",
      personID == 241 ~ "Lady Fellowes",
      personID == 242 ~ "9th Earl Spencer",
      personID == 243 ~ "Countess Spencer",
      personID == 244 ~ "7th Earl of Harewood",
      personID == 246 ~ "Landgrave of Hesse-Darmstadt",
      personID == 251 ~ "Crown Prince of Hanover",
      personID == 262 ~ "Duke of Cambridge",
      personID == 271 ~ "Grand Duke of Mecklenburg-Strelitz",
      personID == 272 ~ "Grand Duke of Mecklenburg-Strelitz",
      personID == 278 ~ "1st Marquess of Cambridge",
      personID == 280 ~ "1st Earl of Athlone",
      ...
      personID == 293 ~ "8th Earl of Harewood",
      personID == 359 ~ "Reverend",
      personID == 384 ~ "3rd Duke of Abercorn",
      personID == 386 ~ "2nd Duke of Abercorn",
      personID == 388 ~ "4th Earl of Lucan",
      personID == 428 ~ "Grand Duchess",
      personID == 431 ~ "Infante of Spain; Duke of Segovia",
      personID == 432 ~ "Count of Barcelona",
      personID == 441 ~ "Queen of Spain",
      personID == 442 ~ "Infanta of Spain",
      personID == 443 ~ "Infanta of Spain",
      personID == 451 ~ "Crown Princess of Norway",
      personID == 453 ~ "Queen of Norway",
      personID == 474 ~ "Queen",
      personID == 479 ~ "Margrave of Baden",
      personID == 484 ~ "Duke of Württemberg",
      personID == 494 ~ "Countess Mountbatten of Burma",
      personID == 500 ~ "Countess Mountbatten of Burma",
      personID == 501 ~ "Lady Pamela Hicks",
      personID == 502 ~ "Marchioness of Milford Haven",
      personID == 504 ~ "3rd Marquess of Milford Haven",
      personID == 505 ~ "7th Baron Brabourne",
      personID == 513 ~ "Countess of Hohenau",
      personID == 515 ~ "Grand Duke of Mecklenburg-Schwerin",
      personID == 531 ~ "Grand Duke of Tuscany",
      personID == 564 ~ "Grand Duke of Mecklenburg-Strelitz",
      personID == 578 ~ "Duke of Nassau",
      personID == 590 ~ "Duke of Orléans",
      personID == 591 ~ "Duke of Segovia",
      personID == 592 ~ "Infanta of Spain",
      ...
      personID == 621 ~ "Grand Duke of Baden",
      personID == 623 ~ "Hereditary Prince of Baden",
      personID == 625 ~ "Grand Duke of Baden",
      personID == 629 ~ "11th Duke of Hamilton",
      ...
      personID == 765 ~ "Elector Palatine",
      personID == 766 ~ "Duke of Cumberland",
      personID == 768 ~ "Count Palatine of Simmern",
      personID == 770 ~ "Duke of York and Albany",
      personID == 781 ~ "2nd Earl Spencer",
      personID == 782 ~ "Countess Spencer",
      personID == 789 ~ "3rd Earl of Lucan",
      personID == 790 ~ "Countess of Lucan",
      personID == 791 ~ "Duchess of Richmond",
      personID == 792 ~ "5th Duke of Richmond",
      personID == 803 ~ "7th Duke of Buccleuch",
      personID == 807 ~ "Baron Fellowes",
      personID == 836 ~ "6th Earl of Angus",
      personID == 839 ~ "1st Duke of Suffolk",
      personID == 863 ~ "3rd Baron Latimer",
      personID == 864 ~ "Baron Seymour",
      personID == 871 ~ "Holy Roman Emperor",
      personID == 873 ~ "6th Earl of Leicester",
      personID == 876 ~ "2nd Earl of Pembroke",
      ...
      personID == 1599 ~ "Elector Palatine",
      ...
      personID == 1828 ~ "Queen",
      personID == 1832 ~ "6th Lord of Annandale",
      personID == 1834 ~ "Earl of Gloucester",
      personID == 1835 ~ "5th Lord of Annandale",
      personID == 1837 ~ "Earl of Huntingdon",
      personID == 1839 ~ "Earl of Chester",
      personID == 1846 ~ "King of Scots",
      personID == 1848 ~ "6th Earl of Surrey",
      personID == 1867 ~ "Count of Poitou",
      personID == 1870 ~ "2nd Earl of Surrey",
      personID == 1875 ~ "Earl of Chester",
      personID == 1877 ~ "Earl of Gloucester",
      personID == 1883 ~ "Earl of Pembroke",
      personID == 1887 ~ "Earl of Cornwall",
      personID == 1890 ~ "Earl of Gloucester",
      personID == 1893 ~ "Count of Aumale",
      personID == 1894 ~ "Count of Artois",
      personID == 1897 ~ "Count of Dreux",
      personID == 1904 ~ "2nd Earl of March",
      personID == 1906 ~ "1st Earl of March",
      personID == 1907 ~ "2nd Baron Mortimer",
      personID == 1908 ~ "1st Baron Mortimer",
      personID == 1914 ~ "1st Marquess Wellesley",
      personID == 1915 ~ "1st Earl of Mornington",
      personID == 1916 ~ "Countess of Mornington",
      personID == 1917 ~ "1st Duke of Wellington",
      personID == 1918 ~ "Viscount Dungannon",
      personID == 1922 ~ "Earl of Hereford",
      personID == 1929 ~ "Holy Roman Emperor",
      ...
      personID == 2058 ~ "1st Earl of Kent",
      personID == 2059 ~ "3rd Earl of Ulster",
      personID == 2069 ~ "Earl of Hereford",
      personID == 2070 ~ "Earl of Stafford",
      personID == 2071 ~ "Duke of Buckingham",
      personID == 2079 ~ "Countess of Devon",
      personID == 2080 ~ "Earl of Devon",
      personID == 2082 ~ "Earl of Warwick",
      personID == 2083 ~ "Duke of Somerset",
      personID == 2084 ~ "Duke of Somerset",
      personID == 2091 ~ "Earl of Wiltshire and Ormond",
      personID == 2093 ~ "Lord Howth",
      personID == 2096 ~ "Earl of Stafford",
      personID == 2099 ~ "Earl of Wiltshire",
      personID == 2102 ~ "Duchess of Somerset",
      personID == 2103 ~ "Earl of Essex",
      personID == 2104 ~ "Earl of Cumberland",
      personID == 2108 ~ "Earl of Hertford",
      personID == 2127 ~ "1st Earl of Clarendon",
      personID == 2135 ~ "Queen of Spain",
      personID == 2141 ~ "Duchess of Celle",
      personID == 2145 ~ "2nd Earl Waldegrave",
      personID == 2155 ~ "2nd Duke of Connaught",
      personID == 2158 ~ "2nd Marquess of Milford Haven",
      personID == 2160 ~ "1st Baron Mount Temple",
      personID == 2180 ~ "Lord Rhys",
      personID == 2191 ~ "5th Baron Inchiquin",
      personID == 2192 ~ "4th Baron Inchiquin",
      personID == 2193 ~ "3rd Baron Inchiquin",
      personID == 2194 ~ "2nd Baron Inchiquin",
      personID == 2195 ~ "King of Thomond",
      personID == 2202 ~ "King of Thomond",
      personID == 2217 ~ "Earl of Pembroke",
      personID == 2218 ~ "Countess of Pembroke",
      personID == 2228 ~ "Earl of Huntingdon",
      personID == 2234 ~ "Queen of Norway",
      personID == 2269 ~ "Duke of Burgundy",
      personID == 2270 ~ "Count of Saint-Pol",
      personID == 2271 ~ "Earl Rivers",
      personID == 2276 ~ "Duke of Suffolk",
      personID == 2277 ~ "2nd Earl of Kent",
      personID == 2278 ~ "Lord Cherleton",
      personID == 2279 ~ "Earl of Stafford",
      personID == 2280 ~ "4th Earl of March",
      personID == 2283 ~ "5th Earl of March",
      personID == 2288 ~ "Earl of Pembroke",
      personID == 2289 ~ "Earl of Arundel",
      personID == 2290 ~ "Lord St John",
      personID == 2291 ~ "Holy Roman Emperor",
      personID == 2292 ~ "Duke of Exeter",
      personID == 2293 ~ "Lord Fanhope",
      personID == 2295 ~ "Earl of Gloucester",
      personID == 2299 ~ "Lord Clifford",
      personID == 2300 ~ "Lord Latimer",
      personID == 2303 ~ "1st Marquess of Hertford",
      personID == 2305 ~ "2nd Duke of Grafton",
      personID == 2306 ~ "Duchess of Grafton",
      personID == 2307 ~ "1st Duke of Grafton",
      ...
      personID == 2312 ~ "Earl of Warwick",
      personID == 2313 ~ "Earl of Warwick",
      personID == 2315 ~ "Earl of Leicester",
      personID == 2317 ~ "Lady Sidney",
      personID == 2318 ~ "Countess of Huntingdon",
      personID == 2319 ~ "Countess of Warwick",
      personID == 2323 ~ "Countess of Warwick",
      personID == 2326 ~ "4th Duke of Norfolk",
      personID == 2329 ~ "3rd Earl of Huntingdon",
      personID == 2332 ~ "2nd Earl of Pembroke",
      personID == 2334 ~ "Countess of Derby",
      personID == 2335 ~ "4th Earl of Derby",
      personID == 2338 ~ "Viscount Rochford",
      personID == 2341 ~ "2nd Duke of Norfolk",
      personID == 2343 ~ "3rd Duke of Norfolk",
      personID == 2345 ~ "Duchess of Norfolk",
      personID == 2348 ~ "1st Baron Howard of Effingham",
      personID == 2353 ~ "3rd Earl of Derby",
      personID == 2354 ~ "2nd Earl of Sussex",
      personID == 2355 ~ "Earl of Surrey",
      personID == 2356 ~ "Duchess of Richmond and Somerset",
      personID == 2357 ~ "Viscount Bindon",
      personID == 2359 ~ "4th Duke of Norfolk",
      personID == 2360 ~ "1st Earl of Northampton",
      personID == 2364 ~ "Duke of Richmond and Somerset",
      personID == 2366 ~ "Duchess of Norfolk",
      personID == 2367 ~ "Earl of Arundel",
      personID == 2368 ~ "Countess of Arundel",
      personID == 2369 ~ "Earl of Arundel",
      personID == 2372 ~ "1st Earl of Suffolk",
      personID == 2374 ~ "Countess of Suffolk",
      personID == 2375 ~ "2nd Earl of Suffolk",
      personID == 2376 ~ "1st Earl of Berkshire",
      personID == 2383 ~ "Duke of Newcastle",
      personID == 2384 ~ "2nd Earl of Salisbury",
      personID == 2385 ~ "3rd Earl of Essex",
      ...
      personID == 2392 ~ "Duke of Somerset",
      personID == 2393 ~ "Duchess of Somerset",
      personID == 2394 ~ "Baron Hunsdon",
      personID == 2396 ~ "Lord Beauchamp",
      personID == 2397 ~ "1st Baron Seymour of Trowbridge",
      personID == 2403 ~ "Lady Knollys",
      personID == 2407 ~ "Earl of Banbury",
      personID == 2411 ~ "1st Earl of Essex",
      personID == 2414 ~ "Lord Offaly",
      personID == 2415 ~ "Elector Palatine",
      personID == 2416 ~ "Queen",
      personID == 2418 ~ "Holy Roman Emperor",
      personID == 2419 ~ "Holy Roman Emperor",
      personID == 2420 ~ "Holy Roman Emperor",
      personID == 2426 ~ "Duke of Burgundy",
      personID == 2427 ~ "Electress",
      personID == 2430 ~ "Holy Roman Emperor",
      personID == 2431 ~ "Holy Roman Emperor",
      personID == 2432 ~ "Empress",
      personID == 2433 ~ "Holy Roman Emperor",
      personID == 2434 ~ "Holy Roman Emperor",
      ...
      personID == 2470 ~ "Count of Dreux",
      personID == 2472 ~ "bishop",
      personID == 2485 ~ "Queen",
      personID == 2501 ~ "Duke of Orléans",
      personID == 2507 ~ "Duke of Berry",
      personID == 2508 ~ "Queen",
      personID == 2512 ~ "Queen of Sweden",
      personID == 2515 ~ "Duke of Orléans",
      personID == 2516 ~ "Duke of Orléans",
      personID == 2517 ~ "Duke of Orléans; Regent",
      personID == 2518 ~ "Duke of Burgundy",
      personID == 2520 ~ "Countess of Hainaut",
      personID == 2524 ~ "Count of Angoulême",
      personID == 2525 ~ "Count of Angoulême",
      personID == 2533 ~ "Duke of Burgundy",
      personID == 2541 ~ "Dauphine of France",
      personID == 2554 ~ "daughter of Charlemagne",
      personID == 2578 ~ "son of Charles the Bald",
      personID == 2615 ~ "Queen",
      personID == 2618 ~ "Queen",
      personID == 2632 ~ "1st Baron Geddes",
      personID == 2633 ~ "Queen",
      personID == 2634 ~ "Princess of Asturias",
      ...
      personID == 2832 ~ "Countess Madeleine",
      personID == 2839 ~ "Princess George of Greece and Denmark",
      personID == 2842 ~ "Princess of Greece and Denmark",
      personID == 2845 ~ "Princess of Greece and Denmark",
      ...
      personID == 2875 ~ "Princess of Asturias",
      personID == 2876 ~ "Queen",
      personID == 2877 ~ "Queen",
      personID == 2879 ~ "Queen",
      personID == 2881 ~ "Queen",
      ...
      personID == 2892 ~ "Duchess of Savoy",
      ...
      personID == 2913 ~ "Duchess of Savoy",
      personID == 2914 ~ "Duchess of Montpensier",
      personID == 2915 ~ "Duchess of Montpensier",
      personID == 2916 ~ "Duchess of Orléans",
      personID == 2917 ~ "Duchess of Lorraine",
      personID == 2918 ~ "Duke of Lorraine",
      personID == 2933 ~ "8th Viscount Powerscourt",
      personID == 2934 ~ "7th Viscount Powerscourt",
      personID == 2935 ~ "Lady Powerscourt",
      personID == 2940 ~ "3rd Earl of Romney",
      personID == 2943 ~ "Duke of Buccleuch",
      personID == 2945 ~ "Duchess of Buccleuch",
      personID == 2949 ~ "1st Viscount Hampden",
      personID == 2951 ~ "Earl of Dalkeith",
      personID == 2952 ~ "2nd Duke of Buccleuch",
      personID == 2953 ~ "2nd Earl of Leicester",
      personID == 2954 ~ "1st Earl of Leicester",
      personID == 2956 ~ "Earl of Albemarle",
      personID == 2963 ~ "Lady Kitty Spencer",
