...
#> timestamp: 2026-07-06 18:04:07 
#> Wall clock time: 0.1409674 secs 
#> optimizer:  SLSQP 
...
#> To get additional fit indices, see help(mxRefModels)
#> timestamp: 2026-07-06 18:04:08 
#> Wall clock time: 0.05225849 secs 
#> optimizer:  SLSQP 
#> OpenMx version number: 2.22.11 
#> Need help?  See help(mxSummary)
```
...
parameters via maximum likelihood. Please see the vignettes on “Fitting
Pedigree-Based Variance Component Models” for detailed examples of this
process.
